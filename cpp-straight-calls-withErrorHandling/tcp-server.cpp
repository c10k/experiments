...
int main(int argc, char *argv[])
{
	...
	hints.ai_socktype = SOCK_STREAM;  // SOCK_STREAM = TCP, SOCK_DGRAM = ?
	...
	// in further examples, we're going to use fork() call for each client
	// connection
	while (1) {
		...
		// send call sends the data you specify as second param and it's length
		// as 3rd param, also returns how many bytes were actually sent
